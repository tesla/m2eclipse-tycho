...
public class Tycho012LifecycleMappingTest
    extends AbstractLifecycleMappingTest
{
        ...
        throws Exception
    {
        IMavenProjectFacade facade =
            importProjectAndAssertLifecycleMappingType( "projects/tycho-0.12", "tycho-eclipse-plugin/pom.xml" );
    ...
    {
        IMavenProjectFacade facade =
            importProjectAndAssertLifecycleMappingType( "projects/tycho-0.12", "tycho-eclipse-feature/pom.xml" );
